...
class Articuler extends StatefulWidget {
  const Articuler({super.key});

  @override
  State<Articuler> createState() => _ArticulerState();
}

class _ArticulerState extends State<Articuler> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: const InputDecoration(
                  hintText: 'Enter prompt relating to the article',
        ...
        //     Navigator.push(
        //       context,
        //       MaterialPageRoute(builder: (context) => const Imageek()),
        //     );
        //   },
        //   child: const Text('Use Imageek'),
        // ),
      ],
    );
  }
...
PreferredSize articulerBar(Size screenSize) {
